...
data1<-data.frame(c(-124,-100,-95,-68,-68,-44,-45,-70,-40),c(55,55,45,40,38,55,53,53,75))
...
bg2$regions[bg2$provnum_ne==9|bg2$provnum_ne==3|bg2$provnum_ne==10]<-"Gulf and Maritimes"

single_sf <- dplyr::bind_rows(list(bg2,eez))
...
p<-ggplot()+
  ...
  #colors
  scale_fill_manual(values=c("blue","darkgreen",alpha("#042333b2",.2),alpha("#13306db2",.2),alpha("#042333b2",.6),alpha("#13306db2",.5),"purple",alpha("#042333b2",.5)))+
  ...
  geom_segment(aes(x=3807133.6, y= 1428977.6, xend=3482440.5,yend= 1999218.3),size=1.2,arrow=arrow(length=unit(.2,"cm")))+
 
  #manual legend
  annotate("rect",xmin=3011465.8,xmax=3311465.8,ymin=5027385.1,ymax=5227385.1,fill = "blue")+
  annotate("text",x=3911465.8,y=5127385.1,label = "Arctic Ocean")+
    annotate("rect",xmin=3011465.8,xmax=3311465.8,ymin=4727385.1,ymax=4927385.1,fill = "darkgreen")+
  annotate("text",x=3911465.8,y=4827385.1,label = "Atlantic Ocean")+
    annotate("rect",xmin=3011465.8,xmax=3311465.8,ymin=4427385.1,ymax=4627385.1,fill = "purple")+
